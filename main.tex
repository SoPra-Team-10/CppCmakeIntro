...
\begin{frame}
    ...
    \begin{itemize}
        \item \st{C with classes}
            ...
            \pause
        \item C++11!
            \pnote{Inzwischen weiter von C entfernt, mehr Konstrukte um sicheren und effizienten Code zu schreiben (Verweis Titel). Neuer Standard inzwischen 17 bald 20}
            \pause
        ...
        \item Wird in quasi jeder Domäne genutzt
            \pnote{Embedded, Betriebssysteme, Systemnahe Entwicklung, Desktop-Anwendungen, Server-Anwendungen, HPC...}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Gehört nicht in die Anwendungslogik
            \pnote{Permanente Fehlerquelle, Zeitverschwendung, Ab jetzt als Raw-Pointer bezeichnet und die wieder verwenden!}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Quasi immer nutzbar
            \pnote{Dafür kopieren... minimal langsamer}
        \item
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Unique-Pointer: Ersatz für Raw-Pointer
            \pnote{Limitierung: Ein Owner dafür Performant}
            \pause
        \item Shared-Pointer: Sichere Pointer für beliebig viele Ownerr
            \pnote{Am Ähnlichsten zu Java, aber etwas Overhead (immer noch weniger als Java)}
            \pause
...
\begin{frame}
    ...
    \begin{itemize}
        \item R-Value Refernenzen, forward/universal Referenzen
            \pnote{Neue Form von Referenz, primär benötigt wenn Speicherverwaltung}
            \pause
        \item Move
            \pnote{Speicher von einer Klasse an eine andere Übergeben, z.B. return, per default da, sonst wenn Speicherverwaltung}
            \pause
        \item Meta-Programming
            \pnote{Touring-vollständige Sprache zur CompileTime, type\_traits}
    \end{itemize}
\end{frame}
